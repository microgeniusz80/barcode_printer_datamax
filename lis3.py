...
class LISApp(tk.Tk):
    def __init__(self):
        ...
        frm_list.place(x=480, y=10, width=490, height=570)
        ...
        self.tests_tree.column("price", width=60, anchor="e")
        ...
        self.total_label = ttk.Label(frm_list, text="Total: 0.00", anchor="e")
    ...
    def open_prices_dialog(self):
        ...
        def save_prices():
            ...
            top.destroy()
            # If a test is selected and you change price, we keep old tests' snapshot price.
            # New tests will use the new price automatically.
    ...
    def update_test_btn(self):
        ...
        # Get currently loaded row to detect name change
